...
from skimage import (color, exposure, feature, filters, graph, io, measure,
...
modules = [color, exposure, feature, filters, graph, measure, metrics,
...
def _get_dispatchables_dict(mod):
    ...
    d['im_true'] = 'ndarray'
    d['im_test'] = 'ndarray'
    d['image_true'] = 'ndarray'
    d['image_test'] = 'ndarray'

    # manually curated list of dispatchables that are not purely ndarray
    d['dtype'] = 'dtype'
    d['out'] = 'noncoercable_ndarray'
    d['color'] = 'str_or_ndarray'  # TODO: handle appropriately
    d['bg_color'] = 'str_or_ndarray'  # TODO: handle appropriately
    d['inverse_map'] = 'callable_or_ndarray'  # TODO: handle appropriately
    return d
...
if __name__ == '__main__':
    ...
    for mod in modules:
        out_name = f'/tmp/_multimethods_{mod.__name__.split(".")[-1]}.py'
